...
GO
ALTER TABLE STAGING.ALLSUBJECTS ADD CONSTRAINT PK_ALLSUBJECTS PRIMARY KEY (ID) 
GO
...
GO
ALTER TABLE STAGING.ALLVARIABLES ADD CONSTRAINT PK_ALLVARIABLES PRIMARY KEY (ID) 
GO